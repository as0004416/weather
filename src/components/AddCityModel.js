    ...
    return(
      ...
      <h1>Расширение списка городов</h1>
        <ul className="addSity-info">
          ...
          <input className="enter-sity" type="text"/></li>
          <li><p className="name-city">Введите название этого города на английском:</p>
          <input className="enter-sity" type="text"/></li>
          <li><p className="name-city">Введите код страны в котором он находится:</p>
          <input className="enter-sity" type="text"/></li>
        </ul>
        <button className="btn-add submit">Добавить</button>
        <button onClick = "btnClose" className="button-close" type="button">Закрыть</button>
      </div>
      </div>
);
  }
